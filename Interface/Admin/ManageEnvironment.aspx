...
<h1>Manage Environment</h1>
    <%--<input id="Create" type="button" value="Create a Department" /> &nbsp; &nbsp; <input id="Update" type="button" value="Lookup a Department" /> --%>
       ...
       <table>
        <tr>
            <td><asp:DropDownList ID="EnvironmentsDropDown" runat="server" Width="300px" DataSourceID="EnvironmentsODS" DataTextField="EnvironmentName" DataValueField="EnvironmentID">
                <asp:ListItem Selected="True">Please select Environment</asp:ListItem>
                </asp:DropDownList></td>
            <td><asp:Button ID="LookupEnvironmentButton" runat="server" Text="Lookup" OnClick="LookupEnvironmentButton_Click" /></td>
        </tr>
       </table>
    <br />
      <table>
        <tr>
            <td> <asp:TextBox ID="EnvironmentIDTextBox" runat="server" Visible="false"></asp:TextBox></td>
        </tr>
        <tr>
            <td><asp:Label ID="Label2" runat="server" Text="Environment Name:"></asp:Label></td>
            <td><asp:TextBox ID="EnvironmentNameTextBox" runat="server"></asp:TextBox> </td>
        </tr>
    ...
    <br /> 
    <asp:Button ID="AddEnvironmentButton" runat="server" Text="Create Environment" OnClick="AddEnvironmentButton_Click" />   
    <asp:Button ID="UpdateEnvironmentButton" runat="server" Text="Update Environment" OnClick="UpdateEnvironmentButton_Click" />
